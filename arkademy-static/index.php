...
<!-- NAVBAR -->
  <nav class="navbar navbar-expand-sm navbar-light bg-light fixed-top bayang">
    <div class="container">
      <a class="navbar-brand" href=""><img src="assets/img/arkademy-logo.png" width="8%"><span class="judul"><span style="color: #FF8FB2;">ARKADEMY</span> COFFEE SHOP</span></a>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <button class="btn text-white pr-5 pl-5" style="background-color: #FF8FB2;">ADD</button>
          </form>
          </div>
        </div>
      </div>
